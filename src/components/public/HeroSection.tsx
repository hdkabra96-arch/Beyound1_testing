...
import { Sparkles, ArrowRight, BookOpen, CheckCircle, Award, Users, ShieldCheck } from 'lucide-react';
import { AnimatedMathGraphics } from './AnimatedMathGraphics';
...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate, onOpenAuth }) => {
  return (
    <section className="relative pt-8 pb-16 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-gradient-to-tr from-indigo-500/10 via-purple-500/10 to-amber-500/10 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
        {/* Top Badges & Main Headlines */}
        <div className="text-center max-w-3xl mx-auto space-y-5">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-800 text-xs font-bold tracking-wide shadow-xs animate-fade-in">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <button
              ...
              className="px-6 py-3.5 rounded-2xl bg-gradient-to-r from-indigo-600 via-indigo-500 to-amber-500 text-white font-extrabold text-sm shadow-xl shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-[1.02] transition-all flex items-center gap-2 cursor-pointer"
            >
        ...
        {/* Animated Mathematics Graphics Feature Showcase */}
        <AnimatedMathGraphics />
